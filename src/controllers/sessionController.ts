...
export const registerUser = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    // Note: Ensure your SessionService has the correct function name (registerUser, not registeUser)
    const user = await SessionService.registerUser(username, email, hashedPassword);
